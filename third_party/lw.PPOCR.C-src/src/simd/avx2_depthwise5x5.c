...
#  include <immintrin.h>
#  define LW_COMPILES_AVX2_DEPTHWISE5X5 1
#else
#  define LW_COMPILES_AVX2_DEPTHWISE5X5 0
#endif

#if LW_COMPILES_AVX2_DEPTHWISE5X5 && (defined(__GNUC__) || defined(__clang__))
...
#if LW_COMPILES_AVX2_DEPTHWISE5X5
